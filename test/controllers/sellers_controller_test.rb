...
class SellersControllerTest < ActionController::TestCase
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post :create, seller: { commerce_id: @seller.commerce_id, store_id: @seller.store_id, user_id: @seller.user_id }
    end
  ...
  test "should update seller" do
    patch :update, id: @seller, seller: { commerce_id: @seller.commerce_id, store_id: @seller.store_id, user_id: @seller.user_id }
    assert_redirected_to seller_path(assigns(:seller))
  end
